...
class Smarty
{
     ...
     * $smarty->display('file:login.tpl');
     * $smarty->display('db:login.tpl');
     * $smarty->display('login.tpl'); // will use default resource type
     * {include file="file:login.tpl"}
     * {include file="db:login.tpl"}
     * {include file="login.tpl"} {* will use default resource type *}
     *
     * @var array
     */
