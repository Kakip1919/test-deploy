            ...
            <div class="panel tab-A is-show">
                <div class="text-center square_background">
                    ...
                    <div class="result_cal">
                        <h2 class="text-center font-size">{$subtitle}</h2>
                        <div class="trans_block"></div>
                        <h2 class="text-center font-size">{$cal_result}</h2>
                        {/if}
                        {if $wareki_flag eq 1}
                        <h3 class="text-center font-size">{$wareki_subtitle}</h3>
                        <div class="trans_block"></div>
                        <h3 class="text-center font-size">{$wareki_result}</h3>
                    </div>
                    {/if}
                </div>
